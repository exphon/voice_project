# Generated by Django 4.2.7 on 2026-06-05 06:52
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('analysis_type', models.CharField(choices=[('basic', '기본 분석'), ('snr', 'SNR 분석'), ('alignment', '정렬 분석'), ('diarization', '화자 분리 분석'), ('ddk', 'DDK 분석'), ('custom', '사용자 정의 분석')], default='basic', help_text='분석 유형', max_length=20)),
            ...
            options={
                ...
                'ordering': ['-created_at'],
                'indexes': [models.Index(fields=['analysis_type', 'status'], name='voice_analy_analysi_c07cfe_idx'), models.Index(fields=['created_at'], name='voice_analy_created_23c4f5_idx')],
            },
        ),
    ]
