...
# 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

# 환경변수로 토큰 설정
os.environ["HUGGING_FACE_HUB_TOKEN"] = "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"
...
pipeline = transformers.pipeline(
    ...
    token="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"
)
...
while True:
    ...
    # 토큰 개수 계산
    generated_tokens = len(pipeline.tokenizer.encode(outputs[0]["generated_text"])) - len(pipeline.tokenizer.encode(prompt))
